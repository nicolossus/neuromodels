...
def constant(I_amp=0.1, T=120, dt=0.01, t_stim_on=10, t_stim_off=110, r_soma=15):
    """
...
def equilibrating(I_amp=0.1, T=200, dt=0.01, t_stim_on=10, t_stim_off=110, r_soma=15):
    """
    Consctructs array I of input stimulus with
